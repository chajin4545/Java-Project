...
<body>
	...
	<div class="row px-4">
		<form action="/assignment2_jad_client/admin_sales_filter" method="get">
			<input type="text" id="category" name="salesfilter" value="all"
				style="display: none;" />
			<button class='text-white bg-warning'>GET ALL TOURS</button>
		</form>
	</div>
	<%
	...
	<%
	if (request.getParameter("salesfilter") != null && (request.getParameter("salesfilter").equals("byTour") || request.getParameter("salesfilter").equals("all"))) {
	%>
